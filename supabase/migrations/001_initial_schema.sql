...
-- Description: Initial schema setup for Line-by-Line journaling app
...
-- 7. Create RLS policies for entries table
...
-- 9. Create RLS policies for question_templates table
...
-- 10. Create RLS policies for streak_analytics table
...
-- Function to update streak analytics
...
-- Function to get weekly entries
...
-- Function to get user's active questions (for LLM integration)
...
BEGIN
  ...
  IF active_template_questions IS NULL THEN
    SELECT us.default_questions INTO default_questions
...
-- Function to update streak analytics when entries change
...
-- 13. Create a function to initialize user settings when a new user signs up
...
-- Migration complete!
-- You can now use the Line-by-Line journaling app with Supabase 